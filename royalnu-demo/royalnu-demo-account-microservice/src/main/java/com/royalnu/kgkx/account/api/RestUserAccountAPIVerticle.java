package com.royalnu.kgkx.account.api;

import com.royalnu.common.RestAPIVerticle;
import com.royalnu.kgkx.account.Account;
import com.royalnu.kgkx.account.AccountService;
...
public class RestUserAccountAPIVerticle extends RestAPIVerticle {
  ...
  private void apiAddUser(RoutingContext context) {
    ...
    System.out.println("接收到的对象:"+account.toJson().toString());
